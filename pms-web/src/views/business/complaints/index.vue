    ...
    <div class="Jcommon-layout">
        <div class="Jcommon-layout-center">
            <el-row class="Jcommon-search-box" :gutter="16">
                <el-form :model="queryParams" ref="queryForm" v-show="showSearch">
                    <el-col :span="6">
                        <el-form-item label="投诉单号" prop="no">
                            <el-input v-model="queryParams.no" placeholder="请输入投诉单号" clearable size="small" @keyup.enter.native="handleQuery" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="投诉电话" prop="applyPhone">
                            <el-input v-model="queryParams.applyPhone" placeholder="请输入投诉电话" clearable size="small" @keyup.enter.native="handleQuery" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                    ...
                    <el-col :span="6">
                        <el-form-item label="流程状态" prop="state">
                            <el-select v-model="queryParams.state" placeholder="请选择流程状态" clearable size="small">
                                <el-option v-for="dict in dict.type.complaints_state" :key="dict.value" :label="dict.label" :value="dict.value" />
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
            ...
            <div class="Jcommon-layout-main Jflex-main">
                <div class="Jcommon-head">
                    <el-row :gutter="10" class="mb8">
                        <el-col :span="1.5">
                            <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd" v-hasPermi="['business:complaints:add']">
                                新增
                            </el-button>
                        </el-col>
                    </el-row>
                ...
                <JTable v-loading="loading" :data="complaintsList" @selection-change="handleSelectionChange">
                    <el-table-column label="投诉单号" align="center" prop="no" />
                    <el-table-column label="投诉标题" align="center" prop="title" />
                    <el-table-column label="分类" align="center" prop="applyCategory">
                        <template slot-scope="scope">
                            <dict-tag :options="dict.type.complaints_category" :value="scope.row.applyCategory" />
                        </template>
                    </el-table-column>
                    <el-table-column label="投诉电话" align="center" prop="applyPhone" />
                    <el-table-column label="投诉者姓名" align="center" prop="applyName" />
                    <el-table-column label="投诉时间" align="center" prop="applyTime" width="180">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="流程状态" align="center" prop="state">
                        <template slot-scope="scope">
                            <dict-tag :options="dict.type.complaints_state" :value="scope.row.state" />
                        </template>
                    </el-table-column>
        ...
        <el-dialog class="Jdialog Jdialog_center" :title="title" :visible.sync="open" width="600px" append-to-body lock-scroll>
            <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                ...
                <el-form-item label="投诉分类" prop="applyCategory">
                    <el-select v-model="form.applyCategory" placeholder="请选择投诉分类">
                        <el-option v-for="dict in dict.type.complaints_category" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="投诉人姓名" prop="applyName" :maxlength="20">
                    <el-input v-model="form.applyName" placeholder="请输入投诉人姓名" />
                </el-form-item>
                <el-form-item label="投诉人电话" prop="applyPhone" :maxlength="20">
                    <el-input v-model="form.applyPhone" placeholder="请输入投诉人电话" />
                </el-form-item>
                <el-form-item label="投诉内容" prop="applyContent">
                    <el-input
                        v-model="form.applyContent"
                        placeholder="请输入投诉的内容说明"
                        :maxlength="200"
                        :style="{ width: '100%' }"
                        true
                        type="textarea"
                ...
                <el-form-item label="投诉人要求" prop="applyRequirements">
                    <el-input
                        v-model="form.applyRequirements"
                        placeholder="请输入投诉人要求"
                        :maxlength="200"
                        :style="{ width: '100%' }"
                        true
                        type="textarea"
...
<script>
import { listComplaints, addComplaints } from '@/api/business/complaints';
...
export default {
    ...
    data() {
        return {
            ...
            // 表单校验
            rules: {
                client: [{ required: true, message: '请选择投诉数据来源', trigger: 'blur' }],
                applyHouse: [{ required: true, message: '请选择商铺编号', trigger: 'blur' }],
                applyPhone: [
                    { required: true, message: '投诉电话不能为空', trigger: 'blur' },
                    { pattern: /^1[3|4|5|6|7|8|9][0-9]\d{8}$/, message: '请输入正确的手机号码', trigger: 'blur' },
                ],
                applyName: [{ required: true, message: '申请人姓名不能为空', trigger: 'blur' }],
                applyCategory: [{ required: true, message: '投诉分类不能为空', trigger: 'change' }],
                applyContent: [{ required: true, message: '投诉的内容不能为空', trigger: 'blur' }],
            },
            formVisible: false,
        };
    },
    ...
    methods: {
        ...
        getList() {
            ...
            listComplaints(this.queryParams).then(response => {
                this.complaintsList = response.data.list;
        ...
        toDetail(item) {
            let data = {
                processDefinitionKey: 'complaints',
