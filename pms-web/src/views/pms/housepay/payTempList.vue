<template>
    <div class="Jcommon-layout">
        <div class="Jcommon-layout-center">
            ...
            <div class="Jcommon-layout-main Jflex-main">
                ...
                <JTable v-loading="listLoading" :data="list">
                    ...
                    <el-table-column label="收费项目" prop="feeItemName" algin="left" width="170px" />
        ...
        <CreateForm v-if="formVisible" ref="CreateForm" @refresh="initData" />
        <RefundForm v-if="refundFormVisible" ref="RefundForm" @refresh="initData" />
        <Print v-if="printVisible" ref="Print" @refresh="initData" />
    </div>
</template>

<script>
import request from '@/utils/request';
import CreateForm from './payTempCreate';
...
export default {
    ...
    methods: {
        ...
        create(id, isDetail) {
            ...
            this.$nextTick(() => {
                this.$refs.CreateForm.init(id, this.blockOptions, this.feeItemList, isDetail, this.query.resourceName);
            });
        },
        refund(id, isDetail) {
