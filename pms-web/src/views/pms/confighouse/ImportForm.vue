...
export default {
    data() {
        return {
            ...
            btnLoading: false,
            listLoading: false,
            uploadUrl: process.env.VUE_APP_BASE_API + '/baseconfig/HouseImport/Uploader',
            fileName: '',
            fileList: [],
            active: 1,
            result: {},
    ...
    methods: {
        ...
        next() {
            if (this.active == 1) {
                ...
                request({
                    url: '/baseconfig/HouseImport/Import',
                    method: 'get',
        ...
        templateDownload() {
            const url = process.env.VUE_APP_BASE_API + '/baseconfig/HouseImport/Template';
