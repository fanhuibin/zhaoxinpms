                ...
                >
                    ...
                    <el-col :span="12" style="height: 59px">
                        <el-form-item label="单价" prop="price">
                            <el-input v-model="dataForm.price" placeholder="请输入" :maxlength="50" clearable :style="{ width: '100%' }"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12" style="height: 59px">
    ...
    methods: {
        ...
        getFeeItemList() {
            request({
                ...
                method: 'get',
                data: { type: 'house', generateType: 'base' },
            }).then(res => {
            ...
            if (this.active == 1) {
                this.$refs['elForm'].validate(valid => {
                    if (valid) {
                        ...
                        request({
                            url: `/payment/PaymentBillCreate/getGenerateData`,
                            method: 'post',
                            data: this.dataForm,
                        })
                            .then(res => {
                    ...
                    .then(() => {
                        this.$refs['elForm'].validate(valid => {
                            if (valid) {
                                this.btnLoading = true;
                                request({
                                    url: `/payment/PaymentBillCreate/generate`,
                                    method: 'post',
                                    data: this.dataForm,
                                })
                                    .then(res => {
