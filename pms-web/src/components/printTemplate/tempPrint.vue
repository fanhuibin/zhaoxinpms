    ...
    <div v-if="loaded" style="display: none">
        ...
        <div id="print-body" ref="print-body">
            <table class="body" cellpadding="0" cellspacing="0" style="width: 99%">
                ...
                <tbody>
                    <tr>
                        <td>{{ data.paymentTemp.feeItemName }}</td>
                        <td align="center">{{ data.paymentTemp.feeUser }}</td>
                        <td align="right">{{ data.paymentTemp.amt }}</td>
...
export default {
    ...
    methods: {
        getData(payNo) {
            return request({
                url: '/print/printData/tempPrint?payNo=' + payNo,
                method: 'get',
            });
        },
        print(payNo) {
