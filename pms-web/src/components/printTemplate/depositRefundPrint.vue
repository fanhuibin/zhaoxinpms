    ...
    <div v-if="loaded" style="display: none">
                ...
                <tr>
                    <td align="center" colspan="3">
                        <div style="width: 100%; height: 110px; position: relative">
                            ...
                            <h2 style="width: 60%; margin: 0 auto; line-height: 80px">{{ data.company }} 押金退款单</h2>
        ...
        <div id="print-body" ref="print-body">
            <table class="body" cellpadding="0" cellspacing="0" style="width: 99%">
                ...
                <tbody>
                    <tr>
                        <td>{{ data.paymentDeposit.feeItemName }}</td>
                        <td align="center">{{ data.paymentDeposit.feeUser }}</td>
                        <td align="right">{{ data.paymentDeposit.amt }}</td>
...
export default {
    ...
    methods: {
        getData(payNo) {
            return request({
                url: '/print/printData/depositRefundPrint?refundNo=' + payNo,
                method: 'get',
            });
        },
        print(payNo) {
